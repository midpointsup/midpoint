<template>
  <gmpx-api-loader key=import.meta.env.VITE_GOOGLE_MAPS_API solution-channel="GMP_CCS_autocomplete_v3">
  </gmpx-api-loader>
  <div class="column-display">
    <ul class="nav nav-pills nav-flush flex-column mb-auto text-center">
      ...
      <li>
        <a @click="showPlans" title="Plans" href="#" class="nav-link link-dark side-bar-icon">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-backpack"
            viewBox="0 0 16 16">
            <path
    ...
    mounted() {
      ...
      if (this.placePicker) {
        this.placePicker.addEventListener('gmpx-placechange', () => {
          ...
          this.infowindowContent.children["place-name"].textContent = place.displayName;
          this.infowindowContent.children["place-address"].textContent = place.formattedAddress;
